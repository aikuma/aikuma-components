...
api$1.library.add(faPlay, faStop, faPause);
    ...
    render() {
        return (h("div", { class: "igv" },
            ...
            h("div", { class: "controls" },
                h("aikuma-buttony", { disabled: !this.canRecord(), id: "record", size: "75", color: "#e04912" },
                    h("div", { class: "buttonicon", innerHTML: api$1.icon(this.state.recording ? faPause : faStop).html[0] })),
                h("aikuma-buttony", { disabled: !this.canPlay(), id: "play", size: "75", color: "#e04912" },
                    h("div", { class: "buttonicon", innerHTML: api$1.icon(this.state.playing ? faStop : faPlay).html[0] }))),
